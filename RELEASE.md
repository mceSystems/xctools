...
In this documents you'll find all the necessary steps to release a new version of `xcode`.
...
5. Create a new release on [GitHub](https://github.com/swift-xcode/xcode) including the information from the last entry in the `CHANGELOG.md`.
